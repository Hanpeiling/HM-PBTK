...
output <- function(parms){
  ...
  Dose_water = parms[["Dose_water"]] # ug/ml 
...
required_columns <- c("stop", "time_final_dose", "TC_c", "Dose_water", "BW","Fcard", "VO2","Unbound_fraction", "Cl","logKow", "pH",
                      "sc_blood",
                      "sc_liver",
                      "sc_gonads",
                      "sc_fat",
